...
- **Cover**: monogram K&A serif Cormorant SC + ampersand script emas (wax seal lama DIBUANG, user tolak "rasa mandala"). Tekan = monogram zoom 1.6x + 8 bunga watercolor bertaburan + kad muncul (~1.2s), reduced-motion terus buka.
